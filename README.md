...
### Note:
In the repository you find four images to test the code. image0.png and image1.png are the QA logo with different arrangement of the dots, while image2.png and image3.png are a checkboard with different arrangement of the dots.
